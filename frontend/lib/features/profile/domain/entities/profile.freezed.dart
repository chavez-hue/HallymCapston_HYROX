...
class _$ProfileImpl implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, name: $name, email: $email, photoUrl: $photoUrl, puzzleCount: $puzzleCount, totalDistanceKm: $totalDistanceKm, bestPace: $bestPace, totalRunTime: $totalRunTime, level: $level, completedShapeIds: $completedShapeIds)';
  }
