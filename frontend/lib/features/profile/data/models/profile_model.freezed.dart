...
mixin _$ProfileModel {
  ...
  List<String> get completedShapeIds => throw _privateConstructorUsedError;
      ...
      _value.copyWith(
            ...
            level: null == level
                ...
                : level // ignore: cast_nullable_to_non_nullable
                      as String,
            completedShapeIds: null == completedShapeIds
                ? _value.completedShapeIds
                : completedShapeIds // ignore: cast_nullable_to_non_nullable
                      as List<String>,
          )
          as $Val,
    );
...
class _$ProfileModelImpl implements _ProfileModel {
  const _$ProfileModelImpl({
    ...
    this.totalRunTime = '',
    this.level = 'Beginner',
    final List<String> completedShapeIds = const [],
  }) : _completedShapeIds = completedShapeIds;
  ...
  @JsonKey()
  final String level;
  final List<String> _completedShapeIds;
  @override
  @JsonKey()
  List<String> get completedShapeIds {
    if (_completedShapeIds is EqualUnmodifiableListView)
      return _completedShapeIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_completedShapeIds);
  }

  @override
  String toString() {
    return 'ProfileModel(id: $id, name: $name, email: $email, photoUrl: $photoUrl, puzzleCount: $puzzleCount, totalDistanceKm: $totalDistanceKm, bestPace: $bestPace, totalRunTime: $totalRunTime, level: $level, completedShapeIds: $completedShapeIds)';
  }
  ...
  int get hashCode => Object.hash(
    ...
    totalRunTime,
    level,
    const DeepCollectionEquality().hash(_completedShapeIds),
  );
...
abstract class _ProfileModel implements ProfileModel {
  const factory _ProfileModel({
    ...
    final String totalRunTime,
    final String level,
    final List<String> completedShapeIds,
  }) = _$ProfileModelImpl;
